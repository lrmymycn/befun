...
public class BaseEasteView<M extends Serializable> extends BaseView<M> {
    ...
    public BaseEasteView() {
        super();
    }

    public BaseEasteView(M model) {
        super();
        this.model = model;
    }
    ...
    public boolean equals(Object obj) {
        ...
        BaseEasteView<?> other = (BaseEasteView<?>) obj;
        if (bid == null) {
    ...
    public String toString() {
        return "BaseView [id=" + id + ", bid=" + bid + ", removed=" + removed + ", creationDate=" + creationDate + ", lastModifiedDate=" + lastModifiedDate
               + ", enabled=" + enabled + "]";
    }
