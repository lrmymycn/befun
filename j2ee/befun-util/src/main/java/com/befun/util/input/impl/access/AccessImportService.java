...
public class AccessImportService implements ImportService {
	...
	@Transactional(propagation = Propagation.REQUIRED)
	public void updateMediaProjectProperty(ImportDataSource ds)
			throws ImportException {
		List<Media> list = ds.listMedias();
		for (Media o : list) {
			if (o.getProjectBid() != null) {
				Project tmpPro = dbService.getByBid(Project.class,
						o.getProjectBid());
				Media exist = mergeService.getMediaByBid(o.getBid());
				if (exist != null) {
